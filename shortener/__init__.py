...
from shortener.views.health import health
from shortener.views.snippet_redirects import snippet_redirects_blueprint
from shortener.views.snippets import snippets_blueprint
...
def create_app():
    ...
    app.register_blueprint(snippets_blueprint)
    app.register_blueprint(snippet_redirects_blueprint)
